<script>
  ...
  import Chart from '/src/lib/component/chart.svelte'; // Use the updated Chart component with pie chart custom labels
  ...
  const barChartData = {
    ...
    datasets: [{
      label: 'Total Kunjungan per Bulan',
      data: [50, 70, 60, 90, 100,95,105,75,90,110,100,120],
  ...
  const pieChartData = {
    ...
    datasets: [{
      label: 'Jenis Orang yang Berkunjung',
      data: [90, 50, 25, 25],
